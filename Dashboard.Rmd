...
\
We will use the **MANN-WHITNEY U TEST** which will allow us to see if our sample of flying and groundtype pokemons' speeds come from significantly different populations, ie if the populations have a significant difference in their distribution.
\
