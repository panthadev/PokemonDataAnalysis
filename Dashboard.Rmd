...
# Dragon = compareTypeAcrossGen("Dragon")
# Electric = compareTypeAcrossGen("Electric")
# Fairy = compareTypeAcrossGen("Fairy")
# Fighting = compareTypeAcrossGen("Fighting")
# Fire = compareTypeAcrossGen("Fire")
# Ghost = compareTypeAcrossGen("Ghost")
# Grass = compareTypeAcrossGen("Grass")
# Ground = compareTypeAcrossGen("Ground")
# Ice = compareTypeAcrossGen("Ice")
# Normal = compareTypeAcrossGen("Normal")
# Poison = compareTypeAcrossGen("Poison")
# Psychic = compareTypeAcrossGen("Psychic")
# Rock = compareTypeAcrossGen("Rock")
# Water = compareTypeAcrossGen("Water")
# Dark = compareTypeAcrossGen("Dark")
# Flying = compareTypeAcrossGen("Flying")
# Steel = compareTypeAcrossGen("Steel")
...
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Dragon, name = "Dragon", marker = list(color = "pink"))
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Electric, name = "Electric")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Fairy, name = "Fairy")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Fighting, name = "Fighting")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Fire, name = "Fire")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Ghost, name = "Ghost")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Grass, name = "Grass")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Ground, name = "Ground")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Ice, name = "Ice")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Normal, name = "Normal")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Poison, name = "Poison")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Psychic, name = "Psychic")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Rock, name = "Rock")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Water, name = "Water")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Dark, name = "Dark")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Flying, name = "Flying")
# q2FinalGraph = q2FinalGraph %>% add_trace(y = Steel, name = "Steel")
